...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción de lang/en/validation.php. Las claves tienen que coincidir
    | exactamente con las del archivo en inglés: si falta una, Laravel usa la
    | del idioma de respaldo (APP_FALLBACK_LOCALE) y ese mensaje sale en inglés.
    |
    | Los :placeholders NO se traducen: :attribute es el nombre del campo,
    | :min / :max / :value / :date / :values los completa el validador.
    |
    */
    ...
    'doesnt_start_with' => 'El campo :attribute no puede empezar con ninguno de los siguientes valores: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute apareció en una filtración de datos. Elegí otro.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Formato: 'campo' => ['regla' => 'mensaje']. Estos ganan por sobre los
    | genéricos de arriba, y sirven para explicar el POR QUÉ de una regla en
    | vez de repetir la regla en palabras.
    |
    */
    ...
    'custom' => [
        'nombre' => [
            ...
            'max' => 'El nombre del proyecto no puede superar los :max caracteres.',
        ],
        'fecha_inicio' => [
        ...
        'monto' => [
            ...
            'max' => 'El monto no puede superar los :max.',
            'integer' => 'El monto debe ser un número entero, sin puntos ni comas.',
        ],
        'estado' => [
            'in' => 'El estado debe ser uno de los cuatro válidos: pendiente, en curso, finalizado o cancelado.',
        ],
        'created_by' => [
            'exists' => 'El usuario indicado en created_by no existe.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplazan a :attribute en los mensajes. Sin esto, un campo llamado
    | "fecha_inicio" sale como "fecha inicio" (Laravel solo cambia el guion
    | bajo por un espacio) en vez de "fecha de inicio".
    |
    */
